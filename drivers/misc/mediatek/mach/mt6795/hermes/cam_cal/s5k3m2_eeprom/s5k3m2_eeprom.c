...
static struct i2c_board_info __initdata kd_cam_cal_dev={ I2C_BOARD_INFO(CAM_CAL_DRVNAME, 0x36)};
...
static int CAM_CAL_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    if(TRUE != hwPowerOn(9, VOL_2800, CAM_CAL_DRVNAME))
    {
...
static int CAM_CAL_Release(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    spin_unlock(&g_CAM_CALLock);
    if(TRUE != hwPowerDown(9, CAM_CAL_DRVNAME))
    {
